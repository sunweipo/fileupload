package com.swp.fileupload.config;
...
/**
 * @author user
 * @version $Revision: 1.0 $, $Date: 2021年7月26日 下午5:14:47 $
 */
...
public class TransactionAdviceConfig {
     ...
     * 定义切点路径
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.swp.fileupload.service.*.*(..))";
    ...
    public TransactionInterceptor TxAdvice() {
        ...
        txMap.put("count*", transactionAttribute2);
